...
- `benchmarks/SearchEngine.CompetitorBenchmarks/` — library benchmark harness (SearchEngine.Sharp version comparison; external libs planned). CSV evidence under `audits/.../artifacts/competitor-benchmarks/`.
